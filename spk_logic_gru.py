from ai_engine_gru import hitung_prediksi_depan_gru

def evaluasi_spk_gru(hari_target, model, scaler, df):
    margin_rp = hari_target * 1500 
    
    harga_sekarang = df.iloc[-1]['Harga_Emas_IDR_per_Gram']
    harga_prediksi = hitung_prediksi_depan_gru(hari_target, model, scaler, df)
