...
def buat_grafik_multimodal(df, list_prediksi, hari_target, warna_garis):
    ...
    fig.update_layout(
        title={
            'text': "<b>Grafik Multimodal: Evaluasi Historis vs Proyeksi LSTM</b>",
            'y': 0.98,
            'x': 0.5,
            'xanchor': 'center',
            'yanchor': 'top',
        ...
        yaxis_title="Indeks Tren (Base = 100)",
        height=600,
        hovermode="x unified",
